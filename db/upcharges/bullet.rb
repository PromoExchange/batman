...
# Product Level
file_name = File.join(Rails.root, 'db/upcharge_data/bullet_product.csv')
...
puts 'Loading Bullet supplier upcharges'

file_name = File.join(Rails.root, 'db/upcharge_data/bullet_supplier.csv')
