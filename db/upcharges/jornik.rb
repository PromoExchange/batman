...
# Product Level
file_name = File.join(Rails.root, 'db/upcharge_data/jornik_product.csv')
...
puts 'Loading Jornik supplier upcharges'

file_name = File.join(Rails.root, 'db/upcharge_data/jornik_supplier.csv')
