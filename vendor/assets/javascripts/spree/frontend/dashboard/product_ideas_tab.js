$(function() {
  $('#product-ideas-tab').click(function() {
    ...
    var buyer_id = $("#buyer-product-ideas-table").attr("data-id");
    var auction_url = 'api/request_ideas?state=open,complete&buyer_id='+buyer_id;
        ...
        if (data.length > 0) {
          ...
          $.each(data, function(i, item) {
            ...
            start_auction = action_template({
              ...
              request_idea_id: item.id,
              url: 'auctions/new?product_id='+item.product_id,
              name: 'Start Auction'
            });
