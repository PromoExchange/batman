class Spree::Admin::ProductLoadsController < Spree::Admin::BaseController
  def index
    ...
    @loaded_factories = Spree::Product.joins(:supplier)
      ...
      .count
    @dc_suppliers = DistributorCentral::Supplier.supplier_list
  end

  def create
    Resque.enqueue(ProductLoadFactory, name: params[:factory_name], dc_acct_num: params[:dc_acct_num])
  ...
  def product_load_params
    params.require(:product_load).permit(:factory_name, :dc_acct_num)
  end
end
